...
public class RevolvingCreditRetailPlanParametersInitializer extends AbstractBillingAccountPlanParametersInitializer {
    private BillingCycleInitializer nextInitializer;
    public RevolvingCreditRetailPlanParametersInitializer(BillingCycleInitializer nextInitializer){
    ...
    public BillingAccount initialize(Product product, BillingAccount oldBillingAccount, BillingAccount newBillingAccount) {
        ...
        System.out.println("IN RevolvingCreditRetailPlanParametersInitializer");
