...
public class RevolvingCreditCashAccountPlanBalancesInitializer extends AbstractBillingAccountPlanBalancesInitializer {
    private BillingCycleInitializer nextInitializer;

    public RevolvingCreditCashAccountPlanBalancesInitializer(BillingCycleInitializer nextInitializer){
    ...
    public BillingAccount initialize(Product product, BillingAccount oldBillingAccount, BillingAccount newBillingAccount) {
        ...
        System.out.println("In RevolvingCreditCashAccountPlanBalancesInitializer");
